...
export default function ChessGamePage() {
  ...
  const handlePlayWithAI = () => {
    ...
    router.push(`/game/chess/ai`);
  };

  return (
    <div className="min-h-screen bg-gray-100 p-8">
      <h1 className="text-3xl font-bold text-center mb-8">Choose Your Chess Adventure</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
        ...
        >
          <h2 className="text-xl font-semibold mb-4">Play Chess with AI</h2>
